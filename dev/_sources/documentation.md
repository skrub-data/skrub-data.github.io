...
* [Wrangling data with good defaults](default_wranglinghtml.md)
  ...
  * [Transforming only some columns with `ApplyToCols`](modules/default_wrangling/apply_to_colshtml.md)
    * [Using selectors to choose or exclude columns](modules/default_wrangling/apply_to_colshtml.md#using-selectors-to-choose-or-exclude-columns)
    * [Rejecting columns that cannot be handled by a transformer](modules/default_wrangling/apply_to_colshtml.md#rejecting-columns-that-cannot-be-handled-by-a-transformer)
...
* [Multi-column operations](multi_column_operationshtml.md)
  ...
  * [Skrub Selectors, for selecting columns in a dataframe](modules/multi_column_operations/selectorshtml.md)
    ...
    * [Selectors can be combined with the set operators](modules/multi_column_operations/selectorshtml.md#selectors-can-be-combined-with-the-set-operators)
    * [Using selectors with dataframe libraries](modules/multi_column_operations/selectorshtml.md#using-selectors-with-dataframe-libraries)
