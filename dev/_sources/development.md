  ...
  * [How can I contribute?](CONTRIBUTINGhtml.md#how-can-i-contribute)
    ...
    * [Writing your first Pull Request](CONTRIBUTINGhtml.md#writing-your-first-pull-request)
      ...
      * [Setting up the environment](CONTRIBUTINGhtml.md#setting-up-the-environment)
        * [Fork the project](CONTRIBUTINGhtml.md#fork-the-project)
        * [Clone your fork](CONTRIBUTINGhtml.md#clone-your-fork)
        * [Set up your environment](CONTRIBUTINGhtml.md#set-up-your-environment)
        * [Installing pre-commit hooks](CONTRIBUTINGhtml.md#installing-pre-commit-hooks)
        * [Run the tests](CONTRIBUTINGhtml.md#run-the-tests)
...
* [Release process](RELEASE_PROCESShtml.md)
  ...
  * [Before starting the process](RELEASE_PROCESShtml.md#before-starting-the-process)
    * [Install and test the wheel](RELEASE_PROCESShtml.md#install-and-test-the-wheel)
  * [Steps for a minor release](RELEASE_PROCESShtml.md#steps-for-a-minor-release)
    * [Preparing the release branch](RELEASE_PROCESShtml.md#preparing-the-release-branch)
    * [Meanwhile, preparing the post-release PR](RELEASE_PROCESShtml.md#meanwhile-preparing-the-post-release-pr)
    ...
    * [Updating the website repository](RELEASE_PROCESShtml.md#updating-the-website-repository)
    * [Update the conda-forge recipe](RELEASE_PROCESShtml.md#update-the-conda-forge-recipe)
    * [Announcing the release](RELEASE_PROCESShtml.md#announcing-the-release)
  * [Steps for a bugfix release](RELEASE_PROCESShtml.md#steps-for-a-bugfix-release)
    * [Preparing the release branch](RELEASE_PROCESShtml.md#id1)
    * [Pushing the wheel to PyPI](RELEASE_PROCESShtml.md#id2)
    * [Update the conda-forge recipe](RELEASE_PROCESShtml.md#id3)
    * [Announcing the release](RELEASE_PROCESShtml.md#id4)
