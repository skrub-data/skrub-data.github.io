...
[`TableVectorizer`](reference/generated/skrub.TableVectorizerhtml.md#skrub.TableVectorizer) class, you might want to name the file `01_table_vectorizer.py`.
...
is available [here](https://code.visualstudio.com/docs/python/jupyter-support-py).

Once you are happy with your example, you can submit a pull request to the repository,
following the instructions in the [contributing guide](CONTRIBUTINGhtml.md#contributing).
...
objects used in the example (like the [`TableVectorizer`](reference/generated/skrub.TableVectorizerhtml.md#skrub.TableVectorizer)), or other examples.
...
For example, if your example uses the [`TableVectorizer`](reference/generated/skrub.TableVectorizerhtml.md#skrub.TableVectorizer) class multiple times, define
a replacement at the top of the docstring. You may also want to add a reference
to the user guide section about the [`TableVectorizer`](reference/generated/skrub.TableVectorizerhtml.md#skrub.TableVectorizer) class. This can be done as follows:
...
[official Sphinx documentation](https://www.sphinx-doc.org/en/master/usage/referencing.html).
...
to the repository. For more information, see the [contributing guide](CONTRIBUTINGhtml.md#contributing).
