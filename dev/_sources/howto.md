...
design choices, refer to the [User Guide](documentationhtml.md#user-guide). For runnable code, see the
[Example gallery](auto_examples/indexhtml.md). For class and function details, see
the [API Reference](reference/indexhtml.md#api-ref).
