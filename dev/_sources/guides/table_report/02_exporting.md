...
# How to export and share the [`TableReport`](../../reference/generated/skrub.TableReport.md#skrub.TableReport)

The [`TableReport`](../../reference/generated/skrub.TableReport.md#skrub.TableReport) is generated as a standalone HTML file that includes the report
data, the plots, and the Javascript necessary to provide interactivity.

If it is generated inside a notebook (Jupyter or Marimo), the [`TableReport`](../../reference/generated/skrub.TableReport.md#skrub.TableReport) is
...
report from the webpage. The function [`write_html()`](../../reference/generated/skrub.TableReport.md#skrub.TableReport.write_html) should
be used for that:
...
with [`html()`](../../reference/generated/skrub.TableReport.md#skrub.TableReport.html) and  [`html_snippet()`](../../reference/generated/skrub.TableReport.md#skrub.TableReport.html_snippet)
respectively.
...
[`json()`](../../reference/generated/skrub.TableReport.md#skrub.TableReport.json). The schema of the JSON data is reported in
[TableReport JSON schema](../../reference/table_report_json_schema.md#table-report-json-schema).
...
Note that this will export all parts of the [`TableReport`](../../reference/generated/skrub.TableReport.md#skrub.TableReport), including the distribution
...
Finally, [`markdown()`](../../reference/generated/skrub.TableReport.md#skrub.TableReport.markdown) produces a shortened summary of the
