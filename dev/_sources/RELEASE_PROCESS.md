...
- For major/minor releases only, in the documentation branches repository
  [https://github.com/skrub-data/skrub-data.github.io](https://github.com/skrub-data/skrub-data.github.io), update the documentation symlink
...
- Create the branch `release-0.2.0` in
  [skrub-feedstock](https://github.com/conda-forge/skrub-feedstock)
