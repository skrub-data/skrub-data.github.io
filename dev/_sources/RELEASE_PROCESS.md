...
#### NOTE
We follow scikit-learn versioning conventions:
...
- Build the wheel and test it:
  ...
  - See [Install and test the wheel]() above.
...
repository [https://github.com/skrub-data/skrub-data.github.io](https://github.com/skrub-data/skrub-data.github.io):
...
[skrub-feedstock](https://github.com/conda-forge/skrub-feedstock) repository.
...
#### WARNING
This PR should be merged with the rebase mode instead of the usual squash mode.
See the warning in [The doc update has succeeded]() above for instructions on
...
Follow the same steps as for a minor release (see 

```
`Update the conda-forge recipe`_
```
