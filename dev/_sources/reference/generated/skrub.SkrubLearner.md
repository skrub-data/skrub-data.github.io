...
objects are created by calling [`DataOp.skb.make_learner()`](skrub.DataOp.skb.make_learner.md#skrub.DataOp.skb.make_learner) on a
DataOp, or by accessing the `best_learner_` attribute of a [`ParamSearch`](skrub.ParamSearch.md#skrub.ParamSearch)
after fitting it.
  ...
  **what**
  : Indicates which (Apply) node to look for and extract the estimator
    ...
    - If a string, it is the name (set with
      [`DataOp.skb.set_name()`](skrub.DataOp.skb.set_name.md#skrub.DataOp.skb.set_name)) of the step we want to find.
    - If an int, it is the id ([`DataOp.skb.id`](skrub.DataOp.skb.id.md#skrub.DataOp.skb.id)) of the node to
      search for.
...
* **Returns:**
  ...
  : The fitted estimator. Depending on the nature of the estimator it
    may be wrapped in a [`ApplyToCols`](skrub.ApplyToCols.md#skrub.ApplyToCols)
...
[`skrub.DataOp.skb.set_name`](skrub.DataOp.skb.set_name.md#skrub.DataOp.skb.set_name)
...
The IDs of nodes can be inspected with [`DataOp.skb.id`](skrub.DataOp.skb.id.md#skrub.DataOp.skb.id), by
passing `show_ids=True` to [`DataOp.skb.draw_graph()`](skrub.DataOp.skb.draw_graph.md#skrub.DataOp.skb.draw_graph), or in the
nodes’ detailed pages generated by [`DataOp.skb.full_report()`](skrub.DataOp.skb.full_report.md#skrub.DataOp.skb.full_report).
...
Depending on the parameters passed to [`DataOp.skb.apply()`](skrub.DataOp.skb.apply.md#skrub.DataOp.skb.apply), the
estimator we provide may or may not be wrapped in a
[`ApplyToCols`](skrub.ApplyToCols.md#skrub.ApplyToCols) transformer.
...
[`ApplyToCols`](skrub.ApplyToCols.md#skrub.ApplyToCols) which independently fits a separate instance of the
...
gets wrapped in a [`ApplyToCols`](skrub.ApplyToCols.md#skrub.ApplyToCols) which applies it to the subset of columns
...
See [`DataOp.skb.full_report()`](skrub.DataOp.skb.full_report.md#skrub.DataOp.skb.full_report) for more information.
...
* **Parameters:**
  **params**
  : The key is the name of a skrub choice.
    - For numeric choices ([`choose_int()`](skrub.choose_int.md#skrub.choose_int) and [`choose_bool()`](skrub.choose_bool.md#skrub.choose_bool)),
      the value is the choice outcome i.e. the number that will be used
      e.g. 0.05.
    - For enumerated choices ([`choose_from()`](skrub.choose_from.md#skrub.choose_from), [`choose_bool()`](skrub.choose_bool.md#skrub.choose_bool),
      [`optional()`](skrub.optional.md#skrub.optional)), the value is an int: the **index (position)**
...
* **Parameters:**
  **what**
  : - If a string, it is the name (set with
      [`DataOp.skb.set_name()`](skrub.DataOp.skb.set_name.md#skrub.DataOp.skb.set_name)) of the step we want to extract.
    - If an int, it is the id ([`DataOp.skb.id`](skrub.DataOp.skb.id.md#skrub.DataOp.skb.id)) of the node to
      search for.
    - If a callable, it is the search predicate: it accepts a DataOp
      and returns a Boolean. The first node for which it returns True
...
[`DataOp.skb.find_X_y`](skrub.DataOp.skb.find_X_y.md#skrub.DataOp.skb.find_X_y)
: Find the nodes that have been marked with [`DataOp.skb.mark_as_X()`](skrub.DataOp.skb.mark_as_X.md#skrub.DataOp.skb.mark_as_X) and [`DataOp.skb.mark_as_y()`](skrub.DataOp.skb.mark_as_y.md#skrub.DataOp.skb.mark_as_y).
