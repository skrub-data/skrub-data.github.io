...
#### SEE ALSO
[`DataOp.skb.iter_learners_grid`](skrub.DataOp.skb.iter_learners_grid.md#skrub.DataOp.skb.iter_learners_grid)
: Similar function but for exploring all the possible parameter combinations. Cannot be used when the DataOp contains some numeric ranges built with [`choose_float()`](skrub.choose_float.md#skrub.choose_float) or [`choose_int()`](skrub.choose_int.md#skrub.choose_int) with `n_steps=None`.
