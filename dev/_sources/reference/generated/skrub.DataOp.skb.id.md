...
specific node with [`DataOp.skb.find()`](skrub.DataOp.skb.find.md#skrub.DataOp.skb.find) or override its computation
by using the ID as a key in the environment passed, for example, to
[`DataOp.skb.eval()`](skrub.DataOp.skb.eval.md#skrub.DataOp.skb.eval) or `SkrubLearner.predict()`.

Usually, giving a node an explicit name with
[`DataOp.skb.set_name()`](skrub.DataOp.skb.set_name.md#skrub.DataOp.skb.set_name) if preferred than relying on the ID, but
