...
### *class* skrub.LLMEncoder(model_name='intfloat/e5-small-v2', n_components=30, device=None, batch_size=32, token_env_variable=None, cache_folder=None, store_weights_in_pickle=False, random_state=None, verbose=0)
...
in the [Install](../../install.md#installation-instructions) guide for more details.
...
* **Parameters:**
  **model_name**
  : - If a filepath on disk is passed, this class loads the model from that path.
    ...
    performance in the benchmark of [[1]](#r67c9718f17db-1).
  ...
  **n_components**
  : The number of embedding dimensions. As the number of dimensions is different
    ...
    <br/>
    See [[1]](#r67c9718f17db-1) for more details on the choice of the PCA and default
    `n_components`.
  ...
  **cache_folder**
  : Path to store models. By default `~/skrub_data`.
    See [`skrub.datasets.get_data_dir()`](skrub.datasets.get_data_dir.md#skrub.datasets.get_data_dir).
...
[`TableVectorizer`](skrub.TableVectorizer.md#skrub.TableVectorizer) with `n_jobs` > 1) may be computationally
...
| [`fit`](#skrub.LLMEncoder.fit)(column[, y])                                          | Fit the transformer.                                                                   |
|--------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [`fit_transform`](#skrub.LLMEncoder.fit_transform)(column[, y])                      | Fit the LLMEncoder from `column`.                                                      |
| [`get_feature_names_out`](#skrub.LLMEncoder.get_feature_names_out)([input_features]) | Return a list of features generated by the transformer.                                |
| [`get_params`](#skrub.LLMEncoder.get_params)([deep])                                 | Get parameters for this estimator.                                                     |
| [`set_output`](#skrub.LLMEncoder.set_output)(\*[, transform])                        | Default no-op implementation for set_output.                                           |
| [`set_params`](#skrub.LLMEncoder.set_params)(\*\*params)                             | Set the parameters of this estimator.                                                  |
| [`set_transform_request`](#skrub.LLMEncoder.set_transform_request)(\*[, column])     | Configure whether metadata should be requested to be passed to the `transform` method. |
| [`transform`](#skrub.LLMEncoder.transform)(column)                                   | Transform `column` using the LLMEncoder.                                               |
