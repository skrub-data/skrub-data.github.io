...
[`TableReport.json()`](generated/skrub.TableReport.md#skrub.TableReport.json) returns a JSON string whose
...
| `plots_skipped`         | boolean                                                         | `true` when `plot_distributions=False` was passed to<br/>[`TableReport`](generated/skrub.TableReport.md#skrub.TableReport). When `true`, plot keys are absent from<br/>column objects, but `histogram_data` is still present for numeric and<br/>datetime columns. |
...
| `cardinality_threshold` | integer                                                         | The threshold from [`get_config()`](generated/skrub.get_config.md#skrub.get_config) above which a column is<br/>considered high-cardinality. Default: 40.                                                                                                          |
...
| `title`                 | string                                                          | **Optional.** Present only when a `title` argument was passed to<br/>[`TableReport`](generated/skrub.TableReport.md#skrub.TableReport).                                                                                                                            |
...
| `histogram_plot`       | string (SVG)                                                 | **Optional**. Present only when `plots_skipped` is `false`.<br/>Distribution histogram as an inline SVG<br/>string.                                                                        |
| `line_plot`            | string (SVG)                                                 | **Optional**. Present only when `plots_skipped` is <br/><br/>```<br/>``<br/>```<br/><br/>false\`.<br/>Line chart of the column values against the sort column as<br/>an inline SVG string. |
