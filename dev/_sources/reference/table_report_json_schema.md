...
| `order_by`              | string                                                          | **Optional.** Name of the column used for sorting when the deprecated<br/>parameter `order_by` was passed to [`TableReport`](generated/skrub.TableReport.md#skrub.TableReport).                                                                                    |
