...
- [`Joiner`](../../reference/generated/skrub.Joiner.md#skrub.Joiner): fuzzy-joins an external table using a scikit-learn
...
- [`AggJoiner`](../../reference/generated/skrub.AggJoiner.md#skrub.AggJoiner): instead of performing 1:1 joins like [`Joiner`](../../reference/generated/skrub.Joiner.md#skrub.Joiner),
  [`AggJoiner`](../../reference/generated/skrub.AggJoiner.md#skrub.AggJoiner)
...
- [`AggTarget`](../../reference/generated/skrub.AggTarget.md#skrub.AggTarget): in some settings, one can derive powerful features from
...
- [`MultiAggJoiner`](../../reference/generated/skrub.MultiAggJoiner.md#skrub.MultiAggJoiner): extension of the [`AggJoiner`](../../reference/generated/skrub.AggJoiner.md#skrub.AggJoiner) that joins multiple
...
[`fuzzy_join()`](../../reference/generated/skrub.fuzzy_join.md#skrub.fuzzy_join) uses similarities in entries to join tables on one or more
...
In sum, equivalent to [`pandas.merge()`](http://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.merge.html#pandas.merge), the [`fuzzy_join()`](../../reference/generated/skrub.fuzzy_join.md#skrub.fuzzy_join)
has no need for pre-cleaning.

### Using the [`InterpolationJoiner`](../../reference/generated/skrub.InterpolationJoiner.md#skrub.InterpolationJoiner) to join tables using ML predictions

The [`InterpolationJoiner`](../../reference/generated/skrub.InterpolationJoiner.md#skrub.InterpolationJoiner) is a transformer that performs an operation similar
...
This transformer is explored in more detail in [this example](../../auto_examples/03_joining/0080_interpolation_join.md#sphx-glr-auto-examples-03-joining-0080-interpolation-join-py).
