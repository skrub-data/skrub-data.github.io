...
Features generated by each encoder (except the [`GapEncoder`](../../reference/generated/skrub.GapEncoderhtml.md#skrub.GapEncoder)) are always named after
...
The [`GapEncoder`](../../reference/generated/skrub.GapEncoderhtml.md#skrub.GapEncoder) names the columns after the categories it estimates from the
data, which are built by capturing combinations of substrings that frequently co-occur.
More information on the functioning and the theoretical background of the [`GapEncoder`](../../reference/generated/skrub.GapEncoderhtml.md#skrub.GapEncoder)
...
- [`StringEncoder`](../../reference/generated/skrub.StringEncoderhtml.md#skrub.StringEncoder): **the default encoder, strong in most cases**: A strong and quick
...
- [`TextEncoder`](../../reference/generated/skrub.TextEncoderhtml.md#skrub.TextEncoder): **language model-based, strong on text but expensive to run**:
  ...
  environment.
- [`MinHashEncoder`](../../reference/generated/skrub.MinHashEncoderhtml.md#skrub.MinHashEncoder): **very fast encoder, but not as effective as the others**:
...
- [`GapEncoder`](../../reference/generated/skrub.GapEncoderhtml.md#skrub.GapEncoder): **an interpretable, if slower encoder**: The [`GapEncoder`](../../reference/generated/skrub.GapEncoderhtml.md#skrub.GapEncoder) estimates
...
[This example](../../auto_examples/01_encoding/0020_text_with_string_encodershtml.md#example-string-encoders) and this
