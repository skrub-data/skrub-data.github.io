...
<!-- "auto_examples/0100_squashing_scaler.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-0100-squashing-scaler-py"></a>
...
While we use a simple [`MLPRegressor`](https://scikit-learn.org/stable/modules/generated/sklearn.neural_network.MLPRegressor.html#sklearn.neural_network.MLPRegressor) here for
...
**Total running time of the script:** (0 minutes 28.848 seconds)

**Estimated memory usage:**  562 MB
