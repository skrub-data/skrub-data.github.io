...
| [`fit`](#skrub.SelectCols.fit)(X[, y])                                               | Fit the transformer.                         |
|--------------------------------------------------------------------------------------|----------------------------------------------|
| [`fit_transform`](#skrub.SelectCols.fit_transform)(X[, y])                           | Fit to data, then transform it.              |
| [`get_feature_names_out`](#skrub.SelectCols.get_feature_names_out)([input_features]) | Get output feature names for transformation. |
| [`get_params`](#skrub.SelectCols.get_params)([deep])                                 | Get parameters for this estimator.           |
| [`set_output`](#skrub.SelectCols.set_output)(\*[, transform])                        | Set output container.                        |
| [`set_params`](#skrub.SelectCols.set_params)(\*\*params)                             | Set the parameters of this estimator.        |
| [`transform`](#skrub.SelectCols.transform)(X)                                        | Transform a dataframe by selecting columns.  |
