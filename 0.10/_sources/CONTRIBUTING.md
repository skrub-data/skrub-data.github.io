...
- Join our community on [Discord](https://discord.gg/ABaPnm7fDC) for general chat and Q&A.
- Alternatively, you can [start a discussion on GitHub](https://github.com/skrub-data/skrub/discussions).

## What to know before you begin

To understand the purpose and goals behind skrub, please read our
[vision statement](https://skrub-data.org/stable/vision.html).
...
- [Similarity Encoding for Learning with Dirty
  Categorical Variables](https://hal.inria.fr/hal-01806175)
...
1. **Check if an issue already exists**
   by searching the [GitHub issues](https://github.com/skrub-data/skrub/issues?q=is%3Aissue)
...
2. If the issue does not exist, [create a new one](https://github.com/skrub-data/skrub/issues/new).
...
You can find a guide on how to write examples in the [example guide](tutorial_examplehtml.md#tutorial-write-example).
...
- **Check if it has been proposed or implemented** by reviewing
  [open pull requests](https://github.com/skrub-data/skrub/pulls?q=is%3Apr).
- If not, [submit a new issue](https://github.com/skrub-data/skrub/issues/new)
...
- **If you will write the code and submit a Pull Request (PR)**:
  ...
  refer to the section [Writing your first Pull Request](#writing-your-first-pull-request).
...
<a id="writing-your-first-pull-request"></a>
...
present in [Installing from source](installhtml.md#installing-from-source) page.
...
page](https://github.com/skrub-data/skrub/pulls) github should show a
...
- **Performance over readability**:
  ...
  Refer to this [best practice guide](https://stackoverflow.blog/2021/12/23/best-practices-for-writing-code-comments/).
...
tool ([pre-commit docs](https://pre-commit.com)) before any commit
...
You can follow the [Install](installhtml.md#installation-instructions) > “From source” section, if needed.
...
You can download and install pixi from [here](https://pixi.sh/latest/).
...
To add a new entry to the [API reference documentation](reference/indexhtml.md#api-ref) or change its
...
using [pixi](https://pixi.sh/latest/). For example if the env is `ci-py309-min-optional-deps`, it is
